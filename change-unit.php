...
$id = $_GET['id'];
	...
	try {
		...
		$sql = "SELECT id_unidade, nome, id_cliente, fl_ativo
                FROM bel_unidade
                WHERE id_unidade = $id";
              ...
              <div class="card shadow">
                <div class="card-body ">
                  ...
                  <form class="" id="form1" name="form1" action="" method="post">
                      <div class="">
                        <div class="col-lg-12">
                          <input type="hidden" class="form-control mb-2 mr-sm-2" id="unidadeId" name="unidadeId"  value="<?=$id;?>">
                        </div>
                        <div class="col-lg-12">
                          <input type="text" class="form-control mb-2 mr-sm-2" id="unidadeNome" name="unidadeNome" placeholder="Nome Unidade" value="<?=$nome;?>">
                        </div>
                        <div class="col-lg-12">
