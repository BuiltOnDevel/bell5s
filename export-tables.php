...
$id_terminal = 1;
	...
	try {
		...
		$sql = "select id_unidade,nome 
		        from bel_unidade where id_cliente is not null";
        ...
        foreach ($row as $line => $value) {
          ...
          $selectUni .='<option value="'.$value['id_unidade'].'">'.$value['nome'].'</option>';
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800 ">Exporta Tabela</h1>
            <div class="col-lg-4">
              ...
              <div class="card shadow">
                <div class="card-body ">
                  ...
                  <form class="" id="form1" name="form1" action="" method="post">
                      <div class="">
                        <div class="col-lg-12">
                          <input type="date" class="form-control mb-2 mr-sm-2" id="dtInicio" name="dtInicio" placeholder="Data Inicial">
                        </div>
                        <div class="col-lg-12">
                          <input type="date" class="form-control mb-2 mr-sm-2" id="dtTermino" name="dtTermino" placeholder="Data Termino">
                        </div>
                        <div class="col-lg-12">
                          <select class="custom-select " id="selUnidade" name="selUnidade">
                              <option selected >Selecione Unidade</option>
                              <?=$selectUni?>
                            </select>
                        </div>
                        <div class="col-lg-12">
                          <input class="btn btn-success btn-lg btn-block" type="button" name="Exporta" value="Exporta" id="Exporta" />
                        </div>
                      </div>
                  </form>
                </div>
