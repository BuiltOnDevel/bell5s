...
// 01234567890123
// x   x x x x x
$hrv  = substr( $reg->terminal_ts, 0, 4 ) . "-";
$hrv .= substr( $reg->terminal_ts, 4, 2 ) . "-";
$hrv .= substr( $reg->terminal_ts, 6, 2 ) . " ";
$hrv .= substr( $reg->terminal_ts, 8, 2 ) . ":";
$hrv .= substr( $reg->terminal_ts, 10, 2 ) . ":";
$hrv .= substr( $reg->terminal_ts, 12, 2 );
