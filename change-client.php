...
$id = $_GET['id'];
	...
	try {
		...
		$sql = "SELECT id_cliente, nome, fl_ativo
                FROM bel_cliente
                WHERE id_cliente = $id";
              ...
              <div class="card shadow">
                <div class="card-body ">
                  ...
                  <form class="" id="form1" name="form1" action="" method="post">
                      <div class="">
                        <div class="col-lg-12">
                          <input type="hidden" class="form-control mb-2 mr-sm-2" id="clienteId" name="clienteId"  value="<?=$id;?>">
                        </div>
                        <div class="col-lg-12">
                          <input type="text" class="form-control mb-2 mr-sm-2" id="clienteNome" name="clienteNome"  value="<?=$nome;?>">
                        </div>
                        <div class="col-lg-12">
